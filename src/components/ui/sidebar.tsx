...
function SidebarProvider({
  ...
  // Treat tablet portrait the same as mobile — show Sheet drawer instead of
  // fixed sidebar so content has room to breathe.
  const isMobile = _isMobile || isTabletPortrait
