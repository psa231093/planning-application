...
export function TaskTableRow({ task, onEdit }: TaskTableRowProps) {
        ...
        {dueDateInfo ? (
          ...
          <Popover open={scheduleOpen} onOpenChange={handleSchedulePopoverClose}>
            <PopoverTrigger asChild>
              <button className="inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 text-xs text-muted-foreground/50 transition-colors hover:bg-muted hover:text-muted-foreground">
